...
function WhyChoose() {
  ...
  const differentials = t("aboutPage.differentials.items", {
    returnObjects: true,
  });
  return (
      ...
      <div className="container why-choose-container">
        <header className="why-choose-header">
          <span className="why-choose-tag">
            {t("aboutPage.differentials.eyebrow")}
          </span>

          <h2 className="why-choose-title">
            {t("aboutPage.differentials.titlePrefix")} 
            <strong> {t("aboutPage.differentials.titleHighlight")}</strong>
          </h2>

          <div className="why-choose-line" />

          <p className="why-choose-description">
            {t("aboutPage.differentials.description")}
          </p>
        </header>

        <div className="why-choose-grid">
          {differentialIcons.map((item, index) => (
            <article
              key={item.id}
              className="why-choose-card"
            >
              <span className="why-choose-number">
                {differentials[index].number}
              </span>
              ...
              <h3>
                {differentials[index].title}
              </h3>

              <p>
                {differentials[index].text}
              </p>
            </article>
          ))}
        </div>
