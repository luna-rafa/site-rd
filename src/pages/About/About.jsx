...
function About() {
  ...
  const highlights = t("aboutPage.hero.highlights", {
    returnObjects: true,
  });
  ...
  useEffect(() => {
    ...
    document.title = t("aboutPage.seoTitle");
  }, [t, language]);
          ...
          <div className="about-hero-content">
            ...
            <div className="about-description">
              ...
              <p>
                ...
                <strong>{t("aboutPage.hero.descriptionHighlight")}</strong>
              </p>
            </div>
            ...
            <blockquote className="about-quote">
              ...
              <p>
                {t("aboutPage.hero.quotePrefix")}
                <strong>{t("aboutPage.hero.quoteHighlight")}</strong>
              </p>
            </blockquote>
            ...
            <div className="about-actions">
              ...
              >
                ...
                {t("aboutPage.hero.projectsButton")}
              </Link>
              ...
              >
                ...
                {t("aboutPage.hero.contactButton")}
              </Link>
            </div>
          </div>
